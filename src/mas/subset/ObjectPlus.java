...
public class ObjectPlus {
    ...
    /**
     * Writes all extents to a given stream (uses serialization). Class method.
     *
     * @throws IOException
     */
    ...
    /**
     * Reads all extents from a given stream (uses serialization). Class method.
     *
     * @throws IOException
    ...
    /**
     * Shows a given extent. Metoda klasowa.
     *
     * @throws Exception
     */
